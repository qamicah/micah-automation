...
public class test {
    ...
    public void login() throws InterruptedException {
        ...
        actions.moveToElement(mykurly).perform();

        // 로그아웃
        WebElement logout = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__next\"]/div[2]/div[1]/div[1]/div[1]/div/div[13]")));
        logout.click();
